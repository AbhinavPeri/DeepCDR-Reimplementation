...
def train_best_from_study(study_path):
    ...
    trainer = pl.Trainer(logger=logger, callbacks=[RichModelSummary(2), RichProgressBar(), checkpoint_callback],
                         log_every_n_steps=1, max_epochs=100, gpus=2, strategy='ddp')
